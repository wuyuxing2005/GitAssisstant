...
from gitIssueAssitant.core.schemas.task import TaskMetadataResponse, ToolDescriptor

router = APIRouter()


@router.get("/evaluation-options", response_model=TaskMetadataResponse)
def get_evaluation_options() -> TaskMetadataResponse:
