...
from gitIssueAssitant.core.utils.github_pr import parse_github_remote_url
...
class GitHubIssueService:
    ...
    def _repo_path_for_task(self, task: TaskRecord) -> Path | None:
    ...
    def _resolve_issue(self, task: TaskRecord) -> tuple[str, str, int]:
    ...
    def _build_default_comment(self, task: TaskRecord) -> str:
        lines = [
