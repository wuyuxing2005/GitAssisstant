...
class SessionStateRepository:
    """SQLite repository for agent sessions and LangGraph state snapshots."""
    ...
    def load_state_record(self, thread_id: str) -> SessionStateRecord | None:
        with self._connect() as conn:
            row = conn.execute(
...
def default_session_state_db_path(workspace_root: str | Path) -> Path:
    configured = Path(
